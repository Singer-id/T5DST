            ...
            for ti, turn in enumerate(dial_dict["turns"]):
                ...
                if "gpt" in args["model_name"]:
                    ...
                    for slot in slot_temp:
                        ...
                        # task2
                        # slot_lang_two = description[slot]["text2"]
                        # input_text_two = dialog_history + f" {tokenizer.sep_token} {slot_lang_two}"
                        #
                        # if turn_id == 0:
                        ...
                        #     output_text_two = "remain"
                        # elif previous_value_text == 'none':
                        #     output_text_two = "generate"
                        # elif value_text == 'none':
                        #     output_text_two = "delete"
                        # else:
                        #     output_text_two = "change"
